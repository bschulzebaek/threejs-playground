...
export default class PolarStationDescriptor implements SceneDescriptor {
    ...
    static async getSceneContext(renderContext: RenderContext): Promise<SceneContext> {
        ...
        const gltfLoader = new GLTFLoader().setPath('/assets/station/');
        ...
        const blueLamp1 = new THREE.PointLight(0x00fffd, 0.1, 50, 4);
        blueLamp1.castShadow = true;
        blueLamp1.position.set(3, 18, 2);

        const blueLamp2 = new THREE.PointLight(0x00fffd, 0.3, 80, 4);
        blueLamp2.castShadow = true;
        blueLamp2.position.set(1.5, 20, -3);

        const blueLamp3 = new THREE.PointLight(0x00fffd, 0.2, 65, 4);
        ...
        scene.add(
            ...
            blueLamp2,
            blueLamp3,
            new THREE.DirectionalLight(0x404040 , 0.05),
        );
